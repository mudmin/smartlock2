...
INSERT INTO `doors` (`id`, `door`, `disabled`) VALUES
(1, 'Front Door', '0'),
(2, 'Back Door', '0'),
(3, 'Side Door', '0'),
(4, 'Garage Door', '0');
...
--
-- Table structure for table `doors_form`
--

CREATE TABLE `doors_form` (
  `id` int(11) NOT NULL,
  `ord` int(11) NOT NULL,
...
--
-- Dumping data for table `doors_form`
--

INSERT INTO `doors_form` (`id`, `ord`, `col`, `form_descrip`, `table_descrip`, `col_type`, `field_type`, `length`, `required`, `validation`, `label_class`, `field_class`, `input_html`, `select_opts`) VALUES
(1, 10, 'door', 'Door Name', 'Name', 'varchar', 'text', 0, 1, '', '', 'form-control', '', '{"":""}'),
(2, 20, 'disabled', 'Disabled', 'Disabled', 'varchar', 'dropdown', 0, 1, '', '', 'form-control', '', '["Enabled","Disabled"]');
...
(79, 1, '2018-04-11 13:54:35', 'System Updates', 'Reformatted existing vericodes'),
(80, 1, '2018-04-11 13:54:35', 'System Updates', 'Update 3GJYaKcqUtw7 successfully deployed.'),
(81, 1, '2018-04-11 13:54:35', 'System Updates', 'Updated old Blacklisted logs to IP Logging type.'),
(82, 1, '2018-04-11 13:54:35', 'System Updates', 'Added cloaking to users.'),
(83, 1, '2018-04-11 13:54:35', 'System Updates', 'Update 2XQjsKYJAfn1 successfully deployed.'),
(84, 1, '2018-04-11 13:54:35', 'System Updates', 'Updated force_notif to 0 if you had not set it already.'),
(85, 1, '2018-04-11 13:54:35', 'System Updates', 'Update 549DLFeHMNw7 successfully deployed.'),
(86, 1, '2018-04-11 13:54:35', 'System Updates', 'Added registration to settings.'),
(87, 1, '2018-04-11 13:54:35', 'System Updates', 'Update 4Dgt2XVjgz2x successfully deployed.'),
(88, 1, '2018-04-11 13:54:35', 'System Updates', 'Added Vericode Expiry to Users Table.'),
(89, 1, '2018-04-11 13:54:36', 'System Updates', 'Reformatted exiting page titles only if they weren''t modified.'),
(90, 1, '2018-04-11 13:54:36', 'System Updates', 'Update VLBp32gTWvEo successfully deployed.'),
(91, 1, '2018-04-11 13:54:36', 'System Updates', 'Update Q3KlhjdtxE5X successfully deployed.'),
(92, 1, '2018-04-11 13:54:36', 'System Updates', 'Created table fingerprints'),
(93, 1, '2018-04-11 13:54:36', 'System Updates', 'Update qbQsBNQ82Q59 successfully deployed.'),
(94, 1, '2018-04-11 13:54:41', 'User', 'User logged in.'),
(95, 1, '2018-04-11 14:04:38', 'Pages Manager', 'Added 2 permission(s) to unlock.php.'),
(96, 1, '2018-04-11 14:04:38', 'Pages Manager', 'Retitled ''unlock.php'' to ''Unlock page''.'),
(97, 1, '2018-04-11 18:37:50', 'Pages Manager', 'Added 1 permission(s) to door_manager.php.'),
(98, 1, '2018-04-11 18:37:50', 'Pages Manager', 'Retitled ''door_manager.php'' to ''Door Manager''.');
...
(77, 'users/disable2fa.php', 'Disable 2 Factor Auth', 2, 0),
...
(81, 'unlock.php', 'Unlock page', 1, 0),
(82, 'door_manager.php', 'Door Manager', 1, 0),
(83, 'users/twofa.php', '', 1, 0);
...
(16, '3GJYaKcqUtw7', '2018-04-11 13:54:35'),
(17, '3GJYaKcqUtz8', '2018-04-11 13:54:35'),
(18, '69qa8h6E1bzG', '2018-04-11 13:54:35'),
(19, '2XQjsKYJAfn1', '2018-04-11 13:54:35'),
(20, '549DLFeHMNw7', '2018-04-11 13:54:35'),
(21, '4Dgt2XVjgz2x', '2018-04-11 13:54:35'),
(22, 'VLBp32gTWvEo', '2018-04-11 13:54:36'),
(23, 'Q3KlhjdtxE5X', '2018-04-11 13:54:36'),
(24, 'qbQsBNQ82Q59', '2018-04-11 13:54:36');
...
INSERT INTO `users` (`id`, `email`, `email_new`, `username`, `password`, `fname`, `lname`, `permissions`, `logins`, `account_owner`, `account_id`, `company`, `join_date`, `last_login`, `email_verified`, `vericode`, `vericode_expiry`, `active`, `oauth_provider`, `oauth_uid`, `gender`, `locale`, `gpluslink`, `picture`, `created`, `modified`, `fb_uid`, `un_changed`, `msg_exempt`, `last_confirm`, `protected`, `dev_user`, `msg_notification`, `force_pr`, `twoKey`, `twoEnabled`, `cloak_allowed`, `doors`, `schedule`) VALUES
(1, 'userspicephp@gmail.com', NULL, 'admin', '$2y$12$1v06jm2KMOXuuo3qP7erTuTIJFOnzhpds1Moa8BadnUUeX0RV3ex.', 'The', 'Admin', 1, 1, 1, 0, 'UserSpice', '2016-01-01 00:00:00', '2018-04-11 05:54:41', 1, '4FsRuWP2uJoMIT1', '2018-04-11 13:54:41', 0, '', '', '', '', '', '', '0000-00-00 00:00:00', '1899-11-30 00:00:00', '', 0, 1, '2017-10-08 15:24:37', 1, 0, 1, 0, NULL, 0, 0, '', 0),
(2, 'noreply@userspice.com', NULL, 'user', '$2y$12$HZa0/d7evKvuHO8I3U8Ff.pOjJqsGTZqlX8qURratzP./EvWetbkK', 'Sample', 'User', 1, 0, 1, 0, 'none', '2016-01-02 00:00:00', '2017-10-08 15:47:41', 1, '0CHtc5nWOvfghW', '2018-04-11 13:54:35', 1, '', '', '', '', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 0, 0, NULL, 0, 0, 1, 0, NULL, 0, 0, '', 0);
...
INSERT INTO `user_keys` (`id`, `keyid`, `owner`, `disabled`) VALUES
(1, '1234', 1, 0);
...
--
-- Indexes for table `doors_form`
--
ALTER TABLE `doors_form`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `doors`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `doors_form`
--
ALTER TABLE `doors_form`
...
--
ALTER TABLE `fingerprints`
  MODIFY `kFingerprintID` int(11) NOT NULL AUTO_INCREMENT;
--
